...
import com.ssm.entity.RedPacket;
import com.ssm.entity.UserRedPacket;
...
public class UserRedPacketServiceImpl implements UserRedPacketService {
    ...
    Logger logger = LoggerUtil.getLog(UserRedPacketServiceImpl.class);
    ...
    public int grapRedPacketForVersionRetime(Long redPacketId, Long userId) {
        // 记录开始时间
    ...
    @Transactional(isolation = Isolation.READ_COMMITTED, propagation =
            Propagation.REQUIRED)
    public int grapRedPacketForVersionRenum(Long redPacketId, Long userId) {
        for (int i = 0; i < 3; i++) {
            // 获取红包信息，注意version值
            RedPacket redPacket = redPacketDao.getRedPacket(redPacketId);
            // 当前小红包库存大于0
